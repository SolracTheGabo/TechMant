...
while ($row = mysql_fetch_row($result)){
    ...
    echo '<td><div class="btn-group">
              ...
              <ul class="dropdown-menu pull-right" role="menu">
                 <li><a href="cargoseq.php?var='.$row[0].'">Ver o agregar cargos</a>
                  </li>
                 <li> <a href="detaillequipos.php?var='.$row[0].'">Detalles del equipo</a></li>
                </ul>
            </div>
          </td>';
    echo "</tr>";
...
while ($row = mysql_fetch_row($result)){
    ...
    echo '<td><div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu pull-right" role="menu">
                                        <!--<li class="divider"></li>-->
                                        <li><a href="cargoseq.php?var='.$row[0].'">Ver o agregar cargos</a></li>
                                        <li><a href="detaillequipos.php?var='.$row[0].'">Detalles del equipo</a>
                                        </li>
...
function DetaillEqc($sideqcli)
{
  $detaileq = mysql_query("SELECT nom_client, apell_client, marca_eqclient, model_eqclient, SN_eqclient, tipo_eqclient, progreso, problema_eqclient, diagnostico_eqclient FROM Clientes, equipos_clientes WHERE propietario_eqclient = id_client AND id_eqclient =  '$sideqcli'") or die(mysql_error());
  $rowedetaileq = mysql_fetch_row($detaileq);
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>'.$rowedetaileq[0].'</td>
                                            <td>'.$rowedetaileq[1].'</td>
                                            <td>'.$rowedetaileq[2].'</td>
                                            <td>'.$rowedetaileq[3].'</td>
                                            <td>'.$rowedetaileq[4].'</td>
                                            <td>'.$rowedetaileq[5].'</td>
                                            <td>'.$rowedetaileq[6].'</td>                                          
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
...
$cargos = mysql_query("SELECT id_cargo, monto_cargo, descripcion_cargo, fecha_cargo FROM equipos_clientes, cargos_eqpaciente WHERE id_eqclient =  '$sideqcli' AND cod_eqclient = id_eqclient AND saldado = 0") or die(mysql_error());
    
    echo '  <div class="col-lg-6">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Cargos hechos al equipo cliente
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <div class="table-responsive">
 ...
 #Solo visualiza de la primer consulta los arreglo [7] y [8]
 echo '<div class="col-lg-6">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Problema y diganostico
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>'.$rowedetaileq[7].'</td>
                                            <td>'.$rowedetaileq[8].'</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
  ...
  $detailtec = mysql_query("SELECT id_colavor, nom_colaborador, apell_colavorador FROM colavoradores, intra_usuario, equipos_clientes WHERE tecnico = id_intrauser AND cod_colavorador = id_colavor AND id_eqclient =  '$sideqcli';
") or die(mysql_error());
  $rowedetailtec = mysql_fetch_row($detailtec);

echo '<div class="col-lg-6">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Tecnico encargado del proyecto
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <div class="table-responsive table-bordered">
                                <table class="table">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>'.$rowedetailtec[0].'</td>
                                            <td>'.$rowedetailtec[1].'</td>
                                            <td>'.$rowedetailtec[2].'</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
