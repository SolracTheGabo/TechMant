                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <input type="hidden" name="accion" value="chapass">
                                    <input type="hidden" name="cod" value="<?php echo $nick; ?>">
                                    <?php elfue($_SESSION['usuario']);?>
                                    <div class="form-group">
                                        <label>Contraseña nueva</label>
                                        <input class="form-control" type="text" name="npass1" >
                                    </div>
                                     <div class="form-group">
                                        <label>Escriba otravez la contraseña</label>
                                        <input class="form-control" type="text" name="npass2" >
                                    </div>
